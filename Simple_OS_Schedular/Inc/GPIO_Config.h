...
#define GPIO_PORTA_PIN1_MODE                  OUTPUT_SPEED_2MHZ_PUSHPULL
...
/* GPIOC */
#define GPIO_PORTC_PIN13_MODE                 OUTPUT_SPEED_2MHZ_PUSHPULL
#define GPIO_PORTC_PIN14_MODE                 INPUT_ANALOG
#define GPIO_PORTC_PIN15_MODE                 OUTPUT_SPEED_2MHZ_PUSHPULL
